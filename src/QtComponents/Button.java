...
public class Button extends QPushButton implements Component {
    ...
    private void setIdentity(NamedNodeMap nodeMap) {
        ...
        if (!Name.isEmpty()) {
            ...
            this.style = new Style("button", "button", false);
    }
    ...
    public void setStyles() {
        Map<String, Style> styles = QT.styles;
        if (styles.containsKey(Component())) style.addAll(styles.get(Component()));
        if (styles.containsKey(Class)) style.addAll(styles.get(Class));
        if (styles.containsKey(Name)) style.addAll(styles.get(Name));
    }
    ...
    public void setStyle() {
        ...
        if (!(prop = check("icon")).isEmpty()) style.addAttribute("file-icon", prop);
