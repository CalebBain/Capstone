...
public final class Window extends QMainWindow implements Component {
    ...
    public Window(Node node) {
        this.setLayout((QLayout) (layout = new Grid()).Widgit());
    ...
    public void addChild(QObject child, Node node) {
        if (child instanceof QWidget) this.layout.addChild(child, node);
        if (child instanceof QLayout) this.setLayout((QLayout) child);
    }
